    ...
    <LinearGradient colors={["#380036", "#0cbaba"]} style={{ flex: 1 }}>
      <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
        ...
        <View style={styles.container}>
          ...
          <Text style={styles.txtimg}>Konsole</Text>
          <TouchableOpacity
            style={{ position: "relative", marginTop: 20 }}
            onPress={() => navigation.navigate("ProductScreen")}
          >
          ...
          <Text style={styles.txtimg}>Komputery</Text>
          <TouchableOpacity
            style={{ position: "relative", marginTop: 20 }}
            onPress={() => navigation.navigate("ProductScreen")}
          >
          ...
          <Text style={styles.txtimg}>Telefony</Text>
          <TouchableOpacity
            style={{ position: "relative", marginTop: 20 }}
            onPress={() => navigation.navigate("ProductScreen")}
          >
          ...
          <Text style={styles.txtimg}>Telewizory</Text>
        </View>
      </ScrollView>
    </LinearGradient>
  );
